...
Andres:
- Add new icon 
	- 2 changes on bl_HierarchyData.cs
	- Edit icons references in the scriptableobject 
	Path: Assets/Project/Scripts/Utilities/_Editor/Hierarchy/IconsReplacer/HierarchyTagIcon/Content/Editor/Resources/HierarchyData.asset
